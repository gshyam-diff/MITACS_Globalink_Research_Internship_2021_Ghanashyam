...
int main (int argc, char** argv)
{
  ...
  */
  ...
  float theta = 1.1264632116799909; // The angle of rotation in radians
  ...
  */
  ...
  pcl::io::savePCDFile("/home/ghans/catkin2_ws/src/tester_package/src/testgap2.pcd", *transformed_cloud);
